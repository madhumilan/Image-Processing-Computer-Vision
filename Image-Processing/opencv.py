...
try:
	img = cv2.imread("images/dettol.jpeg")
except:
...
# 	# res_blue = cv2.bitwise_and(res_orange, res_orange, mask=mask2)

# 	cv2.imshow("Frame", frame)
# 	cv2.imshow("Mask Orange", mask1)
# 	# cv2.imshow("Mask Blue", mask2)
# 	cv2.imshow("Blue object tracking", res_orange)
